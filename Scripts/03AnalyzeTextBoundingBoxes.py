...
plt.savefig(os.path.join(path, 'Images', 'TweetsPerDay.png'), bbox_inches='tight')
plt.close()
...
text_list_dict = {'public_space': public_space_text, 'stay_home': stay_home_text, 'mobility': mobility_text, 'mobility2': mobility_text2}
