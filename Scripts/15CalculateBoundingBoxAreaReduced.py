...
geoDF.loc[geoDF['area_sqkm'] < 500, ['created_at', 'full_text', 'place.name', 'WKTgeom', 'geometry', 'area_sqkm'] + columns].to_file(os.path.join(path, 'Data', 'TweetsWithTopicScoresUnder500sqkmStatsCanLambertReduced.gpkg'), layer='tweets', driver="GPKG")
...
## Canada has 10998 tweets
## United States has 146425 tweets
